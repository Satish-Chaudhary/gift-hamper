...
4. Create a `.env` file from `.env.example` and add your configuration values
5. Ensure proper file permissions (755 for directories, 644 for files)
6. Create the `assets/images` directory for product images
7. Test the installation

## Environment Variables

This project uses environment variables to store sensitive configuration values like API keys.
