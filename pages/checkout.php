...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Store customer data in session for payment processing
    $_SESSION['payment_data'] = $customerData;
                            ...
                            <form method="POST" action="">
                                ...
                                <div class="payment-methods">
                                    <div class="payment-method">
                                        ...
                                        <label for="razorpay">Razorpay (Credit Card, Debit Card, Net Banking, UPI)</label>
                                    </div>
                                    <div class="payment-method">
